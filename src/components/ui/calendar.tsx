  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-stone-100 [&:has([aria-selected].day-range-end)]:rounded-r-md dark:[&:has([aria-selected])]:bg-stone-800",
          props.mode === "range"
        ...
        day_range_start:
          "day-range-start aria-selected:bg-stone-900 aria-selected:text-stone-50 dark:aria-selected:bg-stone-50 dark:aria-selected:text-stone-900",
        day_range_end:
          "day-range-end aria-selected:bg-stone-900 aria-selected:text-stone-50 dark:aria-selected:bg-stone-50 dark:aria-selected:text-stone-900",
        day_selected:
        ...
        day_outside:
          "day-outside text-stone-500 aria-selected:text-stone-500 dark:text-stone-400 dark:aria-selected:text-stone-400",
